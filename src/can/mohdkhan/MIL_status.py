...
# Retrieves DTC codes from the dongle. 
# note: NOT linked with the DTC library yet. 
...
if port: #if bluetooth object exist in port
        buff_atz = port.send_command("0atz") #atz command
else:
...
print(buff_atz) #should display HEX value
'''
